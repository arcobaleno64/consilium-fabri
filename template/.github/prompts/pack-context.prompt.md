...
1. 輸出 include/exclude 清單（人可讀、可複製）
2. 按上方 Context Pack 格式產生草案
3. 標註「token 估算不可用，建議安裝 code2prompt 或手動控制檔案數量」
...
code2prompt 為 optional tool，未安裝不影響 pack-context 的手動模式。
