...
- S2 基線：`false_positive_rate_pct=0.0`、`avg_validation_ms=338.576`，coverage_tasks: TASK-900/950/951/902（[artifacts/status/kpi_sprint2.json](https://github.com/arcobaleno64/consilium-fabri/blob/master/artifacts/status/kpi_sprint2.json)）。
...
- `artifacts/status/kpi_sprint2.json`
...
[1] Arcobaleno. "artifacts/status/kpi_sprint2.json — S2 KPI baseline." https://github.com/arcobaleno64/consilium-fabri/blob/master/artifacts/status/kpi_sprint2.json (2026-04-16 retrieved)
