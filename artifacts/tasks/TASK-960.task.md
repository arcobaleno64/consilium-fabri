...
| 階段 | 負責 Agent | 說明 |
|------|-----------|------|
| Planning | Claude Code | 定義拆分結構、frontmatter schema、sync 範圍 |
| Coding | Codex CLI → Implementer | 執行檔案拆分、寫 frontmatter、更新 index 與 AGENTS.md |
| Testing | Codex CLI → Tester | 驗證 guard validator、template sync |
