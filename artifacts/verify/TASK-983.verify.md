...
### AC-1: text / JSON artifact 讀取加入明確 byte ceiling
- **Result**: PASS
...
### AC-2: archive fallback 與 provider response 都有 replay byte cap
- **Result**: PASS
...
### AC-3: guard unit tests 覆蓋 oversized artifact / archive / provider response
- **Result**: PASS
...
### AC-4: red-team suite 新增對應 size-boundary static cases 並更新 runbook
- **Result**: PASS
...
### AC-6: 驗證證據包含單元測試、red-team、contract guard 與 TASK-983 status guard
- **Result**: PASS
