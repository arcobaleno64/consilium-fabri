...
| 術語 | 淺白說明 | 主要證據 |
|---|---|---|
| Assurance Level | 驗證強度等級；目前有 `POC`、`MVP`、`Production`。等級越高，必備 artifact 和驗證要求越高。 | `docs/artifact_schema.md` |
...
| Build Guarantee | verify artifact 裡的建置證據；不是口頭說有跑過，而是要明列 build 指令、exit code、輸出尾段。 | `CLAUDE.md`、`docs/artifact_schema.md` |
