...
| improvement artifact | 任務卡住或完成後的改善紀錄；偏人類閱讀的 PDCA / 復盤文件，和給 workflow automation 使用的 `status.json` 不同。 | `docs/artifact_schema.md` §5.8、`docs/workflow_state_machine.md` |
...
| Gate E / PDCA | 任務如果曾 blocked，要先補一份 improvement artifact，完成根因、矯正與預防紀錄後，才能合法恢復流程；這個恢復關卡就叫 Gate E。 | `docs/workflow_state_machine.md`、`docs/artifact_schema.md` |
